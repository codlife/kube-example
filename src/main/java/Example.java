...
public class Example {
    ...
    public static void main(String[] args) {
        String master = "http://39.104.74.209:8443/";
        if (args.length == 1) {
            master = args[0];
        }
       ...
       */
            NonNamespaceOperation<Pod, PodList, DoneablePod, PodResource<Pod, DoneablePod>> podList = client.pods();
            System.out.println(podList.list().getItems().get(0).getMetadata());

            System.out.println(client.services().list().getItems().get(2).getMetadata());
